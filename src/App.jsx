    ...
    <>
      ...
      <div className="container">
        ...
        <div className="links">
          <a className="tile" href="Resume-Shubham_Lal.pdf" target="_blank" rel="noreferrer">
            <div className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                ...
                <path d="M48,128V40a8,8,0,0,1,8-8h96l56,56v40" fill="none" stroke="currentColor"
                  strokeLinecap="round" strokeLinejoin="round" strokeWidth="12" />
                <polyline points="152 32 152 88 208 88" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
                <path d="M48,200H64a16,16,0,0,0,0-32H48v48" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
                <polyline points="216 168 188 168 188 216" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
                <line x1="212" y1="196" x2="188" y2="196" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
                <path d="M128,216a24,24,0,0,0,0-48H114v48Z" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
              </svg>
            </div>
            <p>Resume</p>
            <div className="tile-share-button" onClick={(e) => copyText(e, "https://shubhamlal.in/files/Resume-Shubham-Lal.pdf")}>
          ...
          <a className="tile" href="https://shubhamlal.in" target="_blank" rel="noreferrer">
            <div className="icon">
            ...
            <p>Insights</p>
            <div className="tile-share-button" onClick={(e) => copyText(e, "https://shubhamlal.in")}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                className="bi bi-clipboard" viewBox="0 0 16 16">
                <path
                  d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z" />
          ...
          <a className="tile" href="https://shubhamlal.pages.dev" target="_blank" rel="noreferrer">
            <div className="icon">
              <svg viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="currentColor">
            ...
            <p>Portfolio</p>
            <div className="tile-share-button" onClick={(e) => copyText(e, "https://shubhamlal.pages.dev")}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                className="bi bi-clipboard" viewBox="0 0 16 16">
                <path
                  d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z" />
          ...
          <a className="tile" href="https://github.com/Shubham-Lal" target="_blank" rel="noreferrer">
            <div className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                <rect width="100%" height="100%" fill="none" />
                <path d="M84,240a23.9,23.9,0,0,0,24-24V168" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
                <path d="M172,240a23.9,23.9,0,0,1-24-24V168" fill="none" stroke="currentColor"
                  strokeLinecap="round" strokeLinejoin="round" strokeWidth="12" />
                <path d="M152,168h16a23.9,23.9,0,0,1,24,24v8a23.9,23.9,0,0,0,24,24" fill="none"
                  stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="12" />
                <path d="M104,168H88a23.9,23.9,0,0,0-24,24v8a23.9,23.9,0,0,1-24,24" fill="none"
                  stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="12" />
                <path
            ...
            <p>GitHub</p>
            <div className="tile-share-button" onClick={(e) => copyText(e, "https://github.com/Shubham-Lal")}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                className="bi bi-clipboard" viewBox="0 0 16 16">
                <path
                  d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z" />
          ...
          <a className="tile" href="https://www.linkedin.com/in/shubham-lal" target="_blank" rel="noreferrer">
            <div className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                <rect width="100%" height="100%" fill="none" />
                <rect x="36" y="36" width="184" height="184" rx="8" fill="none" stroke="currentColor"
                  strokeLinecap="round" strokeLinejoin="round" strokeWidth="12" />
                <line x1="120" y1="112" x2="120" y2="176" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
                <line x1="88" y1="112" x2="88" y2="176" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
                <path d="M120,140a28,28,0,0,1,56,0v36" fill="none" stroke="currentColor" strokeLinecap="round"
                  strokeLinejoin="round" strokeWidth="12" />
                <circle cx="88" cy="80" r="10" fill="currentColor" />
              </svg>
            </div>
            <p>LinkedIn</p>
            <div className="tile-share-button" onClick={(e) => copyText(e, "https://www.linkedin.com/in/shubham-lal")}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                className="bi bi-clipboard" viewBox="0 0 16 16">
                <path
                  d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z" />
